...
import com.zoho.crm.api.ziapeopleenrichment.*
...
object CreateZiaPeopleEnrichment {
  ...
  def createZiaPeopleEnrichment(): Unit = {
    ...
    paramInstance.add(ZiaPeopleEnrichmentOperations.CreateZiaPeopleEnrichmentParam().module, "Vendors")
