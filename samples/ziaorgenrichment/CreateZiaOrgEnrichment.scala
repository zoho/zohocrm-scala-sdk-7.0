...
import com.zoho.crm.api.ziaorgenrichment.*
...
object CreateZiaOrgEnrichment {
  ...
  @throws[Exception]
  def createZiaOrgEnrichment(): Unit = {
    ...
    paramInstance.add(ZiaOrgEnrichmentOperations.CreateZiaOrgEnrichmentParam().module, "Leads")
              ...
              case actionWrapper: ActionWrapper =>
                actionWrapper.getZiaorgenrichment.foreach {
                  ...
                  case apiException: APIException =>
                    ...
                    println("Details: ")
                    apiException.getDetails.foreach {
                      case (key, value) => println(s"$key: $value")
                    }
