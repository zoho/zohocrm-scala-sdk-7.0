package duplicatecheckpreferences

import com.zoho.api.authenticator.OAuthToken
import com.zoho.api.authenticator.Token
import com.zoho.crm.api.Initializer
import com.zoho.crm.api.duplicatecheckpreference.*
...
object UpdateDuplicateCheckPreference {

  def updateDuplicateCheckPreference(moduleAPIName: String): Unit = {
    ...
    val response: Option[APIResponse[ActionHandler]] = duplicateCheckPreferenceOperations.updateDuplicateCheckPreference(request)
    if (response != null) {
      response match {
                  ...
                  case Some(actioResponse_1) =>
                    actioResponse_1 match {
                      case successResponse: SuccessResponse =>
                        ...
                        println("Details: ")
                        successResponse.getDetails.foreach {
