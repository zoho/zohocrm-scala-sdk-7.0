package massdeletetags

import com.zoho.api.authenticator.{OAuthToken, Token}
import com.zoho.crm.api.{Initializer, ParameterMap}
import com.zoho.crm.api.massdeletetags.*
...
object GetStatus {
  ...
  def getStatus(): Unit = {
    ...
    paramInstance.add(MassDeleteTagsOperations.GetStatusParam().jobId, "7534770350002")
              ...
              case statusResponseWrapper: StatusResponseWrapper =>
                ...
                statusActionResponses.foreach {
                  ...
                  case apiException: APIException =>
                    ...
                    println("Details: ")
                    if (apiException.getDetails != null) {
                      apiException.getDetails.foreach(entry => {
