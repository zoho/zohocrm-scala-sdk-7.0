...
class CadencesExecutionOperations	{
	def enrolCadences( module: String,  request: BodyWrapper) :Option[APIResponse[ActionHandler]]	={
	...
	def unenrolCadences( module: String,  request: BodyWrapper) :Option[APIResponse[ActionHandler]]	={
		var handlerInstance :CommonAPIHandler = new CommonAPIHandler()
		var apiPath :String = new String()
		apiPath = apiPath.concat("/crm/v7/")
		apiPath = apiPath.concat(module.toString())
