...
developers := List(
  Developer(
    ...
    url = url("https://github.com/zoho/zohocrm-scala-sdk-7.0")
  )
)
crossPaths := false
pomExtra :=
  <url>https://github.com/zoho/zohocrm-scala-sdk-7.0</url>
    <scm>
      <url>https://github.com/zoho/zohocrm-scala-sdk-7.0</url>
      <connection>scm:git:git@github.com:zoho/zohocrm-scala-sdk-7.0</connection>
    </scm>
licenses := Seq(
