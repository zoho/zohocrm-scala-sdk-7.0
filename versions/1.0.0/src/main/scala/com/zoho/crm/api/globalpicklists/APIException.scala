...
class APIException extends ActionResponse with Model with ResponseHandler with ActionHandler with ReplaceActionHandler with ReplaceActionResponse with ReplacedResponseHandler with AssociationsResponseHandler with PickListValuesAssociationsResponseHandler	{
