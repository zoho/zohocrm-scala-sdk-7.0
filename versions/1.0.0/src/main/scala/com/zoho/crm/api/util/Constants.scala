...
object Constants {
  ...
  var SET_TO_CONTENT_TYPE: ArrayBuffer[String] = ArrayBuffer[String]("/crm/bulk/v7/read", "/crm/bulk/v7/write", "/crm/v7/__zia_org_enrichment", "crm/v7/__zia_people_enrichment")
