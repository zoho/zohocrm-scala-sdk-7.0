...
class APIException extends Model with ActionResponse with TransferPipelineActionResponse with ResponseHandler with ActionHandler with TransferPipelineActionHandler	{
